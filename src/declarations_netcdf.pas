...
function nc_get_att_string   (ncid : integer; varid : integer; name : pAnsiChar;var ip : array of ppAnsiChar): integer; cdecl; external netcdf;
...
function nc_free_string(lenp : size_t; ip : array of ppAnsiChar ) : integer; cdecl; external netcdf;
